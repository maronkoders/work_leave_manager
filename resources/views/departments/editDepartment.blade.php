    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id='depTitle'>Edit Department</h4>
            </div>

            <div class="modal-body">
                {!! Form::open(['url' => 'editDepartment', 'method' => 'put', 'class' => 'form-horizontal', 'id'=>"updateDepartmentForm" ,"v-on:submit" =>"updateDepartment" ]) !!}
