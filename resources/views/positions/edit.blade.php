<div class="modal fade modalEditPosition" id="modalEditPosition" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id='depTitle'>Edit Position</h4>
            </div>

            <div class="modal-body">
                {!! Form::open(['url' => 'editPosition', 'method' => 'put', 'class' => 'form-horizontal', 'id'=>"updatePositionForm" ,"v-on:submit" =>"updatePosition" ]) !!}
